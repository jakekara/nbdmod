...
def test_does_find_nbpy_file():
    assert resolve_path("hello_notebook_nbpy", path=["test_notebooks"]) == "test_notebooks/hello_notebook_nbpy.nbpy"
...
def test_does_find_ipynb_file():
    assert resolve_path("hello_notebook", path=["test_notebooks"], ext="ipynb") == "test_notebooks/hello_notebook.ipynb"

def test_results_match_legacy_code():
    assert resolve_path("hello_notebook_nbpy", path=["test_notebooks"]) == find_notebook("hello_notebook_nbpy", ["test_notebooks"])
